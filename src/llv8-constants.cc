...
void SharedInfo::Load() {
  ...
  kParameterCountOffset = LoadConstant(
      "class_SharedFunctionInfo__internal_formal_parameter_count__int", "class_SharedFunctionInfo__internal_formal_parameter_count__uint16_t"
      );

  if (kParameterCountOffset == -1) {
    kParameterCountOffset =
        LoadConstant("class_SharedFunctionInfo__internal_formal_parameter_count__SMI", "class_SharedFunctionInfo__formal_parameter_count__SMI");
  }
...
void Types::Load() {
  ...
  kUncompiledDataWithoutPreParsedScopeType =
      LoadConstant("type_UncompiledDataWithoutPreParsedScope__UNCOMPILED_DATA_WITHOUT_PRE_PARSED_SCOPE_TYPE");
  kUncompiledDataWithPreParsedScopeType =
      LoadConstant("type_UncompiledDataWithPreParsedScope__UNCOMPILED_DATA_WITH_PRE_PARSED_SCOPE_TYPE");
